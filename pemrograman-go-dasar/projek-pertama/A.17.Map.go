...
func main() {
	...
	fmt.Println("# - A.17.5. Deteksi Keberadaan Item Dengan Key Tertentu");
		...
		var value, isExist = exampleFive["C"]
	...
	fmt.Println("# - A.17.6. Kombinasi Slice & Map");
		var exampleSix = []map[string]int{
			map[string]int{"name": 1,   "gender": 1},
			map[string]int{"name": 2,    "gender": 2},
			map[string]int{"name": 3, "gender": 3},
		}
