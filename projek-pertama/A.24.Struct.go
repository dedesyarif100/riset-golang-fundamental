...
func main() {
	...
	var resultExampleThree_SectionTwo = exampleThree{"ethan", 2}
	...
	var resultExampleThree_SectionFive = exampleThree{grade: 2, name: "bruce"}
	...
	fmt.Println("name  :", derivativeExampleSeven.name)
	fmt.Println("age   :", derivativeExampleSeven.age)
	...
	var resultExampleThirTeen_SectionTwo = struct { name string; age int } { "DEDE", 24 }
