...
func main() {
	...
	fmt.Println("# - A.47.2. Metode Salting Pada Hash SHA1");
	    var textExTwo = "this is secret"
		fmt.Printf("original : %s\n\n", textExTwo)

		var hashed1, salt1 = doHashUsingSalt(textExTwo)
		fmt.Printf("hashed 1 : %s\n\n", hashed1)
		// 929fd8b1e58afca1ebbe30beac3b84e63882ee1a

		var hashed2, salt2 = doHashUsingSalt(textExTwo)
		fmt.Printf("hashed 2 : %s\n\n", hashed2)
		// cda603d95286f0aece4b3e1749abe7128a4eed78

		var hashed3, salt3 = doHashUsingSalt(textExTwo)
